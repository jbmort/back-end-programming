...
In this project I was given an angular front end and had to create a backend for the project using the spring framework that would connect purchases made to the SQL database, and provided logic to restrict purchasing based on inventory and adding products to inventory. 
